...
-(void)initializeViewComponents{
    ...
    if ([MYIntroductionPanel runningiOS7]) {
        ...
        skipStringWidth = [skipString wz_sizeWithFont:kSkipButtonFont constrainedToSize:CGSizeMake(MAXFLOAT, MAXFLOAT) lineBreakMode:NSLineBreakByWordWrapping].width;
    }
