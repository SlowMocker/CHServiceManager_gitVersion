...
{
    CIImage *ci_image = [[self class]createQRForString:qrCode];
    UIImage *image = [[self class]createNonInterpolatedUIImageFormCIImage:ci_image withSize:sideLength];
    return [self imageBlackToTransparent:image withRed:60.0f andGreen:74.0f andBlue:89.0f];
}
