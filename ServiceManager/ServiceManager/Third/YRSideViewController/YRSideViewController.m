...
- (void)showShadow:(BOOL)show{
    _currentView.layer.shadowOpacity    = show ? 1.0f : 0.0f;
    if (show) {
        [_currentView setClipsToBounds:NO];
        _currentView.layer.cornerRadius = 18.0f;
        _currentView.layer.shadowOffset = CGSizeMake(10, 10);
        _currentView.layer.shadowRadius = 18.0f;
        _currentView.layer.shadowColor = kColorBlack.CGColor;
